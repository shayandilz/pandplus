                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="row align-items-center justify-content-center g-0">
                            ...
                            <div class="col-12 col-lg-5 bg-success px-5 pt-5 d-flex gap-4 flex-column text-justify ms-n5 mb-5 image-rounded overflow-hidden">
                                <span class="mt-4 mt-lg-0 ps-2 text-primary">
                                ...
                                <div class="position-relative d-flex gap-3 fs-2 ps-3 py-3">
                                    <div class="swiper-button-next-unique d-flex justify-content-center align-items-center gap-3">
