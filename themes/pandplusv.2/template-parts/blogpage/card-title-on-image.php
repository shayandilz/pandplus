<a href="<?php echo get_the_permalink();?>" class="card-main d-flex col-11 shadow col-lg position-relative overflow-hidden align-items-lg-end  align-items-center gx-2">
    <img class="object-fit position-absolute w-100 h-100 start-0" src="<?php echo get_the_post_thumbnail_url();?>" alt="">
    <div class="z-top pb-lg-3 mb-lg-1 text-white px-3 bg-danger card-info w-100">
