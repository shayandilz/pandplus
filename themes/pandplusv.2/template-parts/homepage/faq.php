<div class="container py-5">
    <div class="row">
        <div class="col-12 col-lg-8 bg-success p-5 image-rounded d-flex flex-column gap-4">
        ...
        <div class="col-12 col-lg-4 ms-n5 d-flex flex-row gap-3 my-4 align-items-center">
